 ...
 * types of curves. These flags are for internal library use only. */
    ...
    defined(MBEDTLS_ECP_DP_SECP384K1_ENABLED) || \
    defined(MBEDTLS_ECP_DP_SECP521K1_ENABLED)
...
typedef enum {
    ...
    MBEDTLS_ECP_DP_SECP384K1,
    MBEDTLS_ECP_DP_SECP521K1,
...
#define MBEDTLS_ECP_MAX_BITS 256
#elif defined(MBEDTLS_ECP_DP_SECP384K1_ENABLED)
#define MBEDTLS_ECP_MAX_BITS 384
#elif defined(MBEDTLS_ECP_DP_SECP521K1_ENABLED)
#define MBEDTLS_ECP_MAX_BITS 521
...
int mbedtls_ecp_sw_derive_y(const mbedtls_ecp_group *grp, const mbedtls_mpi *X, mbedtls_mpi *Y, int parity_bit);
