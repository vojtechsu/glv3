...
static const mbedtls_mpi_uint secp384k1_p[] = {
    MBEDTLS_BYTES_TO_T_UINT_8(0x47, 0x64, 0xFD, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF),
    MBEDTLS_BYTES_TO_T_UINT_8(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF),
    MBEDTLS_BYTES_TO_T_UINT_8(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF),
    MBEDTLS_BYTES_TO_T_UINT_8(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF),
    MBEDTLS_BYTES_TO_T_UINT_8(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF),
...
static const mbedtls_mpi_uint secp384k1_a[] = {
    MBEDTLS_BYTES_TO_T_UINT_2(0x00, 0x00),
};
static const mbedtls_mpi_uint secp384k1_b[] = {
    MBEDTLS_BYTES_TO_T_UINT_2(0x07, 0x00),
};
static const mbedtls_mpi_uint secp384k1_gx[] = {
    MBEDTLS_BYTES_TO_T_UINT_8(0xfb, 0x79, 0x16, 0xf, 0xb3, 0x88, 0xa0, 0xad),
    MBEDTLS_BYTES_TO_T_UINT_8(0xb8, 0x4c, 0xe4, 0xa, 0xeb, 0xc1, 0x16, 0x99),
    MBEDTLS_BYTES_TO_T_UINT_8(0x57, 0xa5, 0x14, 0x8a, 0xec, 0xc8, 0xdf, 0x6e),
    MBEDTLS_BYTES_TO_T_UINT_8(0x44, 0x94, 0xa6, 0xe6, 0x59, 0x37, 0x2e, 0xaa),
    MBEDTLS_BYTES_TO_T_UINT_8(0xf3, 0xa, 0x38, 0xb8, 0x86, 0x1e, 0xa2, 0xc4),
    MBEDTLS_BYTES_TO_T_UINT_8(0x9d, 0xbf, 0x9, 0x1, 0x6e, 0x4e, 0x53, 0xce),

};
static const mbedtls_mpi_uint secp384k1_gy[] = {
    MBEDTLS_BYTES_TO_T_UINT_8(0x97, 0x37, 0x95, 0x86, 0x13, 0x5b, 0xcf, 0x5c),
    MBEDTLS_BYTES_TO_T_UINT_8(0xaf, 0x3e, 0xc5, 0x17, 0x62, 0x7, 0xb, 0x15),
    MBEDTLS_BYTES_TO_T_UINT_8(0xe4, 0x27, 0xf2, 0xc8, 0xf7, 0x18, 0x3e, 0x39),
    MBEDTLS_BYTES_TO_T_UINT_8(0x8d, 0xb, 0xe3, 0x5b, 0x10, 0x63, 0xe0, 0xd7),
    MBEDTLS_BYTES_TO_T_UINT_8(0xe9, 0xa9, 0x81, 0x20, 0xd5, 0xb7, 0x6c, 0x2),
    MBEDTLS_BYTES_TO_T_UINT_8(0x3f, 0xf1, 0xc3, 0xca, 0x67, 0x71, 0xcb, 0x45),
};
static const mbedtls_mpi_uint secp384k1_n[] = {
    MBEDTLS_BYTES_TO_T_UINT_8(0x1, 0xa6, 0xf, 0x8f, 0x1a, 0x35, 0xf3, 0xd1),
    MBEDTLS_BYTES_TO_T_UINT_8(0xb7, 0xf9, 0xa7, 0x3b, 0xaf, 0x18, 0xe5, 0xfb),
    MBEDTLS_BYTES_TO_T_UINT_8(0x85, 0x67, 0xcd, 0x2b, 0xfb, 0xe8, 0x73, 0x9f),
    MBEDTLS_BYTES_TO_T_UINT_8(0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF),
    MBEDTLS_BYTES_TO_T_UINT_8(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF),
    MBEDTLS_BYTES_TO_T_UINT_8(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF),
...
static const mbedtls_mpi_uint secp384k1_T[] = {};
#endif /* MBEDTLS_ECP_DP_SECP384K1_ENABLED */


#if defined(MBEDTLS_ECP_DP_SECP521K1_ENABLED)
static const mbedtls_mpi_uint secp521k1_p[] = {
    MBEDTLS_BYTES_TO_T_UINT_8(0xb3,0x50,0xf8,0xff,0xff,0xff,0xff,0xff),
    MBEDTLS_BYTES_TO_T_UINT_8(0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff),
    MBEDTLS_BYTES_TO_T_UINT_8(0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff),
    MBEDTLS_BYTES_TO_T_UINT_8(0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff),
    MBEDTLS_BYTES_TO_T_UINT_8(0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff),
    ...
    MBEDTLS_BYTES_TO_T_UINT_8(0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff),
    MBEDTLS_BYTES_TO_T_UINT_8(0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff),
    MBEDTLS_BYTES_TO_T_UINT_2(0xff,0x1),


};
static const mbedtls_mpi_uint secp521k1_a[] = {
    MBEDTLS_BYTES_TO_T_UINT_2(0x00, 0x00),
};
static const mbedtls_mpi_uint secp521k1_b[] = {
    MBEDTLS_BYTES_TO_T_UINT_2(0x07, 0x00),
};
static const mbedtls_mpi_uint secp521k1_gx[] = {
    MBEDTLS_BYTES_TO_T_UINT_8(0x43,0xa0,0x49,0x1d,0xfd,0x4f,0xfb,0x46),
    MBEDTLS_BYTES_TO_T_UINT_8(0xb7,0xb4,0x9b,0xa3,0x42,0x5f,0xe,0x5c),
    MBEDTLS_BYTES_TO_T_UINT_8(0x98,0x30,0xd6,0xb5,0x7,0x7e,0x8d,0xb0),
    MBEDTLS_BYTES_TO_T_UINT_8(0xf1,0x46,0x53,0xc7,0xb3,0xfc,0x72,0x78),
    MBEDTLS_BYTES_TO_T_UINT_8(0x69,0x88,0x34,0xaa,0x9e,0x61,0x89,0xb4),
    MBEDTLS_BYTES_TO_T_UINT_8(0x9d,0xb9,0x74,0x39,0x7e,0x44,0xf6,0x1b),
    MBEDTLS_BYTES_TO_T_UINT_8(0x80,0x39,0xce,0xa4,0x6e,0xe5,0xff,0x3c),
    MBEDTLS_BYTES_TO_T_UINT_8(0xc1,0xe4,0xda,0xa9,0xd4,0x46,0xbf,0xa1),
    MBEDTLS_BYTES_TO_T_UINT_2(0x44,0x1),

};
static const mbedtls_mpi_uint secp521k1_gy[] = {
    MBEDTLS_BYTES_TO_T_UINT_8(0x8f,0x1b,0x22,0x43,0x6,0x30,0x97,0x31),
    MBEDTLS_BYTES_TO_T_UINT_8(0x2d,0x85,0x84,0x40,0x65,0x20,0x99,0xfa),
    MBEDTLS_BYTES_TO_T_UINT_8(0x7a,0x4d,0x28,0xff,0x21,0xbc,0x9a,0x7a),
    MBEDTLS_BYTES_TO_T_UINT_8(0x7e,0xce,0x97,0x69,0xfa,0x89,0x22,0x4a),
    MBEDTLS_BYTES_TO_T_UINT_8(0x76,0x14,0x18,0xf3,0x42,0x7a,0xfe,0xb5),
    MBEDTLS_BYTES_TO_T_UINT_8(0x4c,0xaa,0x8f,0x44,0xc2,0x80,0xd,0xdb),
    MBEDTLS_BYTES_TO_T_UINT_8(0x8,0xbb,0x45,0xd5,0x1d,0x4d,0x51,0x53),
    MBEDTLS_BYTES_TO_T_UINT_8(0x9e,0x3f,0x98,0xe0,0xfc,0x4d,0x4b,0x4b),
    MBEDTLS_BYTES_TO_T_UINT_2(0x3d,0x0)
};
static const mbedtls_mpi_uint secp521k1_n[] = {
    MBEDTLS_BYTES_TO_T_UINT_8(0x7,0x5a,0xed,0xdf,0x37,0x28,0xf5,0xed),
    MBEDTLS_BYTES_TO_T_UINT_8(0xae,0xe8,0x4a,0x89,0x93,0x5a,0xb3,0x58),
    MBEDTLS_BYTES_TO_T_UINT_8(0x2e,0xdf,0x6d,0xd4,0xc7,0x61,0x59,0xc5),
    MBEDTLS_BYTES_TO_T_UINT_8(0x5a,0x46,0x43,0xd0,0xf9,0x95,0xdc,0x50),
    MBEDTLS_BYTES_TO_T_UINT_8(0xd5,0xff,0xff,0xff,0xff,0xff,0xff,0xff),
    MBEDTLS_BYTES_TO_T_UINT_8(0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff),
    MBEDTLS_BYTES_TO_T_UINT_8(0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff),
    MBEDTLS_BYTES_TO_T_UINT_8(0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff),
    MBEDTLS_BYTES_TO_T_UINT_2(0xff,0x1),
...
static const mbedtls_mpi_uint secp521k1_T[] = {};
#endif /* MBEDTLS_ECP_DP_SECP521K1_ENABLED */
...
#endif
#if defined(MBEDTLS_ECP_DP_SECP384K1_ENABLED)
static int ecp_mod_p384k1(mbedtls_mpi *);
#endif
#if defined(MBEDTLS_ECP_DP_SECP521K1_ENABLED)
static int ecp_mod_p521k1(mbedtls_mpi *);
#endif
...
#if defined(MBEDTLS_ECP_DP_SECP384K1_ENABLED)
        case MBEDTLS_ECP_DP_SECP384K1:
            // grp->modp = ecp_mod_p384k1;
            return LOAD_GROUP_A(secp384k1);
#endif /* MBEDTLS_ECP_DP_SECP384K1_ENABLED */

#if defined(MBEDTLS_ECP_DP_SECP521K1_ENABLED)
        case MBEDTLS_ECP_DP_SECP521K1:
            return LOAD_GROUP_A(secp521k1);
#endif /* MBEDTLS_ECP_DP_SECP521K1_ENABLED */
