...
#endif
#if defined(MBEDTLS_ECP_DP_SECP384K1_ENABLED)
    { MBEDTLS_ECP_DP_SECP384K1,    30,     384,    "secp384k1"         },
#endif
#if defined(MBEDTLS_ECP_DP_SECP521K1_ENABLED)
    { MBEDTLS_ECP_DP_SECP521K1,    31,     521,    "secp521k1"         },
#endif
...
static int ecp_mul_doubleandadd(mbedtls_ecp_group *grp, mbedtls_ecp_point *R,
                        const mbedtls_mpi *m, const mbedtls_ecp_point *P,
                        int (*f_rng)(void *, unsigned char *, size_t),
                        void *p_rng,
                        mbedtls_ecp_restart_ctx *rs_ctx)
                                        ...
                                        mbedtls_ecp_restart_ctx *rs_ctx)
{
    ...
    if(grp->id==MBEDTLS_ECP_DP_SECP384K1 || grp->id==MBEDTLS_ECP_DP_SECP521K1){
        MBEDTLS_MPI_CHK(ecp_mul_doubleandadd(grp, R, m, P, f_rng, p_rng, rs_ctx));
